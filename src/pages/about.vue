		...
		<el-row class="main" type="flex" justify="center">
			<el-col :span="16">
				...
				<div class="statement">
					...
					<div class="item">CSDN：<a target="_blank" href="https://blog.csdn.net/feng_zi_ye">https://blog.csdn.net/feng_zi_ye</a></div>
	            </div>
	            <h5 class="title"><i class="el-icon-star-on"></i>{{$t('about.aboutBlog')}}</h5>
	            <el-card shadow="always">
	            	<dl class="dl-blog">
	            		<dt>{{$t('about.blogSource')}}</dt>
	            		<dd><a target="_blank" href=""><img class="icon" src="../assets/mayun.png" alt="码云" /></a></dd>
...
export default {
  ...
  data() {
	  return {
	    ...
	    rules: {
          name: [
            { required: true, message: this.$t('about.nameTip'), trigger: 'blur' }
          ],
          email: [
            { required: true, message: this.$t('about.emailTip1'), trigger: 'blur' },
      		{ type: 'email', message: this.$t('about.emailTip2'), trigger: ['blur', 'change'] }
          ],
          content: [
            { required: true, message: this.$t('about.contentTip'), trigger: 'blur' }
          ]
        }
	  };
	},
